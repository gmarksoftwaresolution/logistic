...
export const DropScannerScreen: React.FC<any> = ({ route, navigation }) => {
  ...
  const activeSession = activeDropSession;
  ...
  const handleRemoveParcel = async (parcelId: string) => {
    ...
    try {
      ...
      setLocalScannedItems(prev => prev.filter(item => item.parcelId !== parcelId));
      await removeParcel('DROP', activeSession.sessionId, parcelId);
    } catch (err: any) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Drop QR Scanner</Text>
                  ...
                  {isCompleted && (
                    ...
                    >
                      {actionLoading ? (
                        ...
                        <Text style={styles.inlineConfirmBtnText}>Confirm Delivery</Text>
                      )}
                    </TouchableOpacity>
                  )}
                </View>
