...
export const TransporterAddressDetailsScreen: React.FC = () => {
  ...
  // Form State for 6 Address fields
  ...
  const [stateName, setStateName] = useState(personalDetails?.state || '');
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setIsEditing(false);
      Alert.alert('Success', getLabel('profile.updated_success', 'Address details updated successfully.'));
    } catch (err: any) {
      ...
      <View style={styles.headerRow}>
        ...
        <View style={styles.headerTitleCol}>
          <Text style={styles.headerTitle}>
            {getLabel('signup.my_address', 'My Address')}
          </Text>
          <Text style={styles.headerSubtitle}>
            {getLabel('profile.subtitle', 'View and manage your saved address details')}
          </Text>
        </View>
      </View>
        ...
        <View style={styles.detailsCard}>
          ...
          <View style={styles.fieldBoxGroup}>
            ...
            <View style={[styles.inputContainer, isEditing && styles.inputContainerEditing]}>
              {isEditing ? (
                ...
                <Text style={styles.inputValue}>{stateName || '-'}</Text>
              )}
            </View>
          </View>
          ...
          <View style={styles.fieldBoxGroup}>
            ...
            <View style={[styles.inputContainer, isEditing && styles.inputContainerEditing]}>
              {isEditing ? (
                <TextInput
                  style={[styles.textInput, { height: verticalScale(60), textAlignVertical: 'top' }]}
...
export default TransporterAddressDetailsScreen;
