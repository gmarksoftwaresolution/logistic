...
export const RejectReasonModal: React.FC<RejectReasonModalProps> = ({
  ...
  return (
    ...
    >
      {/* Dark overlay */}
      <Animated.View
        style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', opacity: fadeAnim }}
      >
        ...
        >
          ...
          >
            {/* Grab handle */}
            <View style={{ width: 44, height: 4, backgroundColor: '#E2E8F0', borderRadius: 2, alignSelf: 'center', marginTop: 12, marginBottom: 20 }} />
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'flex-start' }}>
                <View style={{ flex: 1, marginRight: 12 }}>
                  ...
                  <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 6 }}>
                    <View style={{ width: 4, height: 20, backgroundColor: '#DC2626', borderRadius: 2, marginRight: 10 }} />
                    <Text style={{ fontSize: 20, fontWeight: '900', color: '#0F172A', letterSpacing: -0.3 }}>
                      Reject Order
                    </Text>
                  </View>
                  <Text style={{ fontSize: 13, color: '#64748B', fontWeight: '500', marginLeft: 14 }}>
            ...
            >
              ...
              >
                <Ionicons name="close-circle" size={18} color="white" style={{ marginRight: 8 }} />
                <Text style={{ fontSize: 14, fontWeight: '800', color: 'white', letterSpacing: 0.2 }}>
                  Submit Rejection
                </Text>
              </TouchableOpacity>
            </View>
