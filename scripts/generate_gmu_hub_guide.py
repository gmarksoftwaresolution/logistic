...
MD_FILE = os.path.join(DOCS_DIR, "GMU_Hub_Technical_Guide.md")
HTML_FILE = os.path.join(DOCS_DIR, "GMU_Hub_Technical_Guide.html")
DOCX_FILE = os.path.join(DOCS_DIR, "GMU_Hub_Technical_Guide.docx")

def build_markdown_content():
    return """# GMU HUB WEB DASHBOARD
