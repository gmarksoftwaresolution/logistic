...
async function main() {
  ...
  for (const o of orders) {
    ...
    // Add random 15-45 minutes for realistic staggered times
    ...
    console.log(`Created order ${orderNumber} (${o.type}) with qty ${qty}, weight ${product.weight}kg, time ${baseTime.toISOString()}`);
  }

  console.log('Successfully seeded 20 specific mixed orders!');
}
