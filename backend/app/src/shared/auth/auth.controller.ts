...
export class AuthController {
  ...
  @Post('login/send-otp')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Send OTP for login (Compatibility Route)' })
  ...
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Verify OTP for login (Compatibility Route)' })
  ...
  @Post('login')
  @HttpCode(HttpStatus.OK)
  @ApiOperation({ summary: 'Login using mobile number and OTP' })
